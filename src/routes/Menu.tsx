...
const Menu = () => (
  <div className="space-children bounded-section">
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                name: "Boutique Ipa",
                price: 6,
                description: "Our best-selling draft beer with bitter taste",
              },
              {
                name: "Absolute Porter",
                price: 7,
                description: "Chocolate peanut butter porter with rich taste",
              },
              {
                name: "Belgian Dream",
                price: 8,
            ...
            items: [
              {
                name: "Monkey Sour",
                price: 10,
                description: "Monkey Shoulder whisky, strawberry, lemon, sugar",
              },
              {
                name: "Old Fashioned",
                price: 11,
              ...
              },
              {
                name: "Piña Colada",
                price: 10,
                description: "Havana Club 3 Year Old rum, coconut, pineapple",
              },
              {
                name: "Mojito",
                price: 11,
              ...
              },
              {
                name: "Bramble",
                price: 13,
                description: "Tanqueray London Dry gin, crème de mure, lemon",
              },
            ],
          },
        ]}
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                name: "Beef King",
                price: 18,
                description: "Beef brisket, Swiss cheese, caramelised onions",
              },
              {
